export const ACTION_SUBSCRIBE_FOR_TASK_LOGS = "coll.SUBSCRIBE_FOR_TASK_LOGS";
...
export const ACTION_APPEND_TASK_LOGS = "coll.APPEND_TASK_LOGS";

export function appendTaskLogs({ id, logs, more = true }) {
  return { id, logs, more, type: ACTION_APPEND_TASK_LOGS };
}

export const ACTION_SET_TASK_LOGS = "coll.SET_TASK_LOGS";
