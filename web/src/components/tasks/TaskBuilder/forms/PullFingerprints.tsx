...
import { PullFingerprintsRequest } from "../../../../model/Task";
...
function useMessages() {
  ...
  return {
    description: intl.formatMessage({
      id: "task.type.pullFingerprints.description",
    }),
    repo: intl.formatMessage({ id: "task.attr.pullRepository" }),
    repoHelp: intl.formatMessage({ id: "task.attr.pullRepository.help" }),
  };
}

function PullFingerprints(
  props: TaskBuilderProps<PullFingerprintsRequest>
): JSX.Element {
  ...
  return (
    <div className={clsx(classes.pullFingerprints, className)}>
      <Description
...
export default PullFingerprints;
