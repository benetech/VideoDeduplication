...
class SemanticSearchStub(object):
    ...
    def __init__(self, channel):
        ...
        self.query_videos = channel.unary_unary(
                ...
                request_serializer=rpc__pb2.TextSearchRequest.SerializeToString,
                response_deserializer=rpc__pb2.TextSearchResults.FromString,
                )
...
def add_SemanticSearchServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'query_videos': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=rpc__pb2.TextSearchRequest.FromString,
                    response_serializer=rpc__pb2.TextSearchResults.SerializeToString,
            ),
    }
...
class SemanticSearch(object):
    ...
    def query_videos(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/rpc.proto.SemanticSearch/query_videos',
            rpc__pb2.TextSearchRequest.SerializeToString,
            rpc__pb2.TextSearchResults.FromString,
